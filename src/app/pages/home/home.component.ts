...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [RouterLink, BadgeComponent, FooterComponent],
  template: `
        ...
        <div class="relative max-w-6xl mx-auto px-6 py-24 md:py-32">
          <div class="max-w-3xl">
            ...
            <h1 class="text-5xl md:text-6xl font-bold leading-tight tracking-tight mb-6">
              <span class="text-zinc-100">Common AG-Grid</span><br />
            ...
            <p class="text-zinc-400 text-lg md:text-xl leading-relaxed max-w-2xl mb-10">
              A hands-on reference for visualizing common AG-Grid features.
            </p>
            ...
            <p class="text-xs text-zinc-600 mt-3">
              Each demo includes source code you can browse inline.
            </p>
          </div>
        </div>
      </section>
